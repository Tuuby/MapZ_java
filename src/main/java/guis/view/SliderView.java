...
public class SliderView {
    ...
    public SliderView(String name, int minSliderValue, int maxSliderValue) {
        ...
        // slider
        slider = new JSlider(JSlider.HORIZONTAL, minSliderValue, maxSliderValue, (maxSliderValue/2)); // value set by DSL
